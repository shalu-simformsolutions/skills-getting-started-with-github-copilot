...
activities = {
    ...
    "Science Olympiad": {
        ...
        "max_participants": 18,
        "participants": ["lisa@mergington.edu", "marcus@mergington.edu"]
    },
    "Gym Class": {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team and compete in league matches",
        "schedule": "Tuesdays, Thursdays, Saturdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "tyler@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Learn soccer skills and participate in friendlies and tournaments",
        "schedule": "Mondays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["brandon@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and other visual arts mediums",
